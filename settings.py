...
DATABASES = {
    'default': {
        ...
        'NAME': os.path.join(SITE_ROOT,'cuibono.db'),                      # Or path to database file if using sqlite3.
...
STATIC_ROOT = '/srv/www/uwsgi/app/cuibono_webservice/static/'
...
ROOT_URLCONF = 'cuibono_webservice.urls'
